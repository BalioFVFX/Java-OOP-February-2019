...
public class Dough {
    ...
    private static LinkedHashMap<String, Double> flourTypes;
    private static LinkedHashMap<String, Double> bakingTechniques;
    ...
    public double calculateCalories(){
        return (2 * weight) * flourTypes.get(this.flourType.toUpperCase()) * bakingTechniques.get(this.bakingTechnique.toUpperCase());
    }
}
